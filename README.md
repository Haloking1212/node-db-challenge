...
Answer: Relational Databases is a digital database based on a `relational model of data` sql is how you manage the relational database.

- [x] Why do tables need a `primary key`?

Answer: A `primary key` is the main id of an object. 

- [x] What is the name given to a table column that references the primary key on another table.

Answer: `immigrant` naw im just kidding its a `foreign key`.

- [x] What do we need in order to have a _many to many_ relationship between two tables.

Answer: you need multiple fields in a table associate with multiple fields in another table.
